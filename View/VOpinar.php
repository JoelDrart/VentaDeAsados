...
<body>
    ...
    <section class="containerPrincipal">
        <?php if (isset($_SESSION['userId'])): ?>
            ...
            <h2>¡Deja una opinión!</h2>

            <div class="container-reserva-ya" style="display: flex; justify-content: center; text-align:center;" >
                
                <form action="../Model/MOpinar.php" method="post">
                    <input type="hidden" name="idPlato" value="<?php echo $idplato; ?>">
                    <input type="hidden" name="idUsuario" value="<?php echo $_SESSION['userId']; ?>">
                    <h3><?php echo obtenerNombrePlatoPorId($idplato); ?></h3>
                    ...
                    <input type="radio" name="calificacion" value="5"> 5 <br><br>
                    ...
                    <input class="button-submit" type="submit" value="Opinar">
                </form>
            </div>
        ...
        <?php else: ?>
            ...
            <h2>Debe iniciar sesión para poder comentar nuestros platos.</h2>
        <?php endif; ?>
    </section>
