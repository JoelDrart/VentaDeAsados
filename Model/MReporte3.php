<?php
    ...
    $sql = "SELECT R.reservaId AS IDReserva, U.nombreUsuario AS NombreCliente, R.fechaReserva AS FechaReserva, R.horaReserva AS HoraReserva, TR.nombreReserva AS Tipo, R.totalPrecio AS TotalCobrar
